...
//   return (
//     <div className="fixed top-0 left-0 z-40 w-full px-6 py-10 lg:px-32 lg:py-10 bg-gray-100 shadow-lg">
//       <div className="flex items-center justify-between px-6 sm:px-10 md:px-20 lg:px-32 py-4">
//         {/* Hamburger Menu */}
//         <button
//           className="block lg:hidden text-customSlate text-3xl"
//           onClick={toggleMenu}
...
//       {/* Mobile Menu */}
//       {isMenuOpen && (
//         <div className="lg:hidden fixed inset-0 bg-gray-100 bg-opacity-95 z-50 flex flex-col items-center justify-center gap-8">
//           <NavLink
//             to="/home"
//             onClick={toggleMenu}
//             className={({ isActive }) =>
