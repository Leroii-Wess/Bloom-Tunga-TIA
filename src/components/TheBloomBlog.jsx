...
//     >
//       <div>
//         <img src="https://picsum.photos/300/200" className="h-full " />
//       </div>
//       <div className="flex flex-col gap-5">
//         <h3 className="text-gray-100 text-3xl font-semibold">{blog.title}</h3>
//         <p className="text-gray-100 text-2xl font-light">{blog.content}</p>
//       </div>
