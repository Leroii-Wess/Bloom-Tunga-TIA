...
function CreateBlog() {
  ...
  return (
    <div className="pt-[100px] bg-green-50 py-16 flex justify-center flex-col items-center">
      <div className="flex items-center justify-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-customSlateDark mt-8 text-center">
          Post a Bloom
        </h2>
      </div>
      ...
      <div className="w-full max-w-xl md:max-w-4xl lg:max-w-6xl p-4 sm:p-8 md:p-12 flex items-center justify-center">
        <form
          onSubmit={handleSubmit}
          className="bg-white p-4 sm:p-6 md:p-8 rounded-md shadow-md w-full space-y-6"
        >
          <div>
            <label
              htmlFor="title"
          ...
          <div>
            <button
              type="submit"
              className="w-full sm:w-auto bg-customSlate text-white font-semibold px-4 py-2 rounded-md shadow hover:bg-customSlateLight transition duration-300"
            >
              Post Bloom
            </button>
          </div>
